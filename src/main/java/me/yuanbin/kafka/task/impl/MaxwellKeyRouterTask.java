...
public class MaxwellKeyRouterTask extends AbstractTask implements ETLTask {

    private static final Logger logger = LoggerFactory.getLogger(MaxwellKeyRouterTask.class);
